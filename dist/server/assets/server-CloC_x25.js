...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DiN9JNE5.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BdIcMqIZ.js"),
    import("./start-D2MdfgP7.js"),
...
var ROUTER_BASEPATH = "najmascafe";
var SERVER_FN_BASE = "/najmascafe/_serverFn/";
